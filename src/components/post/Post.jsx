        ...
        <div className='post'>
            ...
            <div className="postWrapper">
                <div className="postTop">
                    <div className="postTopLeft">
                        <Link to={`/profile/${user.username}`}>
                            <img src={user.profilePicture?publicFolderLink+user.profilePicture:defaultAvatar} alt="" className='postProfileImg'/>
                        </Link>
                ...
                <div className="postCenter">
                    ...
                    {post.img && <img src={publicFolderLink+post.img} alt="" className='postImg' />     }             
                </div>
                <div className="postBottom">
                    <div className="postBottomLeft">
                        <img src={publicFolderLink+"like.png"} alt="" className='likeIcon' onClick={likeIconHandler}/>
                        <img src={publicFolderLink+"heart.png"} alt="" className='heartIcon' onClick={likeIconHandler}/>
